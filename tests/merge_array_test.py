...
from api.schemas.merge_array_schema import merge_array_schema
...
def test_merge_array_schema_good_way(list_1: list, list_2: list) -> None:
    ...
    jsonschema.validate(td_post_body, merge_array_schema)
...
def test_merge_array_schema_mixed_list(list_1: list, list_2: list,
    ...
    jsonschema.validate(td_post_body_variant_1, merge_array_schema)
    jsonschema.validate(td_post_body_variant_2, merge_array_schema)
    jsonschema.validate(td_post_body_variant_3, merge_array_schema)
